...
let cameraAccessDeniedMessage = "ChatterBox needs access to your camera to take photos and videos.\n\nPlease go to Settings –– Privacy –– Camera –– and set ChatterBox to ON."
let contactsAccessDeniedMessage = "ChatterBox needs access to your contacts to create new ones.\n\nPlease go to Settings –– Privacy –– Contacts –– and set ChatterBox to ON."
let microphoneAccessDeniedMessage = "ChatterBox needs access to your microphone to record audio messages.\n\nPlease go to Settings –– Privacy –– Microphone –– and set ChatterBox to ON."
let photoLibraryAccessDeniedMessage = "ChatterBox needs access to your photo library to send photos and videos.\n\nPlease go to Settings –– Privacy –– Photos –– and set ChatterBox to ON."

let cameraAccessDeniedMessageProfilePicture = "ChatterBox needs access to your camera to take photo for your profile.\n\nPlease go to Settings –– Privacy –– Camera –– and set ChatterBox to ON."
let photoLibraryAccessDeniedMessageProfilePicture = "ChatterBox needs access to your photo library to select photo for your profile.\n\nPlease go to Settings –– Privacy –– Photos –– and set ChatterBox to ON."

let videoRecordedButLibraryUnavailableError = "To send a recorded video, it has to be saved to your photo library first. Please go to Settings –– Privacy –– Photos –– and set ChatterBox to ON."
